...
function getBody(RAPIER, world) {
    ...
    heartShape.moveTo( a + .05, b + .05 );
    heartShape.bezierCurveTo( a + .05, b + .05, a + .04, b, a, b );
    heartShape.bezierCurveTo( a - .06, b, a - .06, b + .07,a - .06, b + .07 );
    heartShape.bezierCurveTo( a - .06, b + .11, b - .03, b + .154, a + .05, b + .19 );
    heartShape.bezierCurveTo( a + .12, b + .154, a + .16, b + .11, a + .16, b + .07 );
    heartShape.bezierCurveTo( a + .16, b + .07, a + .16, b, a + .10, b );
    heartShape.bezierCurveTo( a + .07, b, a + .05, b + .05, a + .05, b + .05 );
  ...
  function getMouseBall (RAPIER, world) {
    ...
    let dynamicCollider = RAPIER.ColliderDesc.ball(mouseSize * 7.5);
